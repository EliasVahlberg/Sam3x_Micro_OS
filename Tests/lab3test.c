...
void lab3_test_main()
{
    ...
    retVal = create_task(task_body_3_1, low_deadline);
    if (retVal != OK)
    {
        while (1)
        { /* no use going further */
    ...
    retVal = create_task(task_body_3_2, 8 * high_deadline);
    if (retVal != OK)
    {
        while (1)
        { /* no use going further */
    ...
    retVal = create_task(task_body_3_3, 2 * low_deadline);
    if (retVal != OK)
    {
        while (1)
        { /* no use going further */
    ...
    retVal = create_task(task_body_3_4, 3 * low_deadline);
    if (retVal != OK)
    {
        while (1)
        { /* no use going further */
    ...
    retVal = create_task(task_body_3_5, 4 * low_deadline);
    if (retVal != OK)
    {
        while (1)
        { /* no use going further */
